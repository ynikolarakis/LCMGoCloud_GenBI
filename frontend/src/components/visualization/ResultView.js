...
export function ResultView({ response }) {
    ...
    return (_jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "flex gap-1", children: CHART_OPTIONS.map((opt) => (_jsx("button", { type: "button", onClick: () => setChartType(opt.value), className: `rounded px-2 py-1 text-xs ${chartType === opt.value
