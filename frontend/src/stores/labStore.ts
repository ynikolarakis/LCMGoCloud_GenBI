...
interface LabState {
  ...
  // Current result
  currentResult: DualQueryResponse | null;
...
export const useLabStore = create<LabState>((set, get) => ({
  ...
  validateCurrent: async () => {
    ...
    if (!connectionId || !currentResult) return;
  ...
  clearResults: () =>
    set({ currentResult: null, currentValidation: null, error: null }),
