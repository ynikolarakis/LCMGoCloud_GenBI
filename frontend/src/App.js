...
function NavBar() {
    ...
    return (_jsxs("header", { className: "flex items-center justify-between border-b bg-white px-6 py-3 shadow-sm", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("img", { src: "/logo_en.png", alt: "LCM Go Cloud", className: "h-10 w-10 object-contain" }), _jsx("h1", { className: "text-lg font-semibold text-gray-900", children: "GenBI Platform" })] }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsxs("nav", { className: "flex gap-2", children: [_jsx(NavLink, { to: "/connections", className: linkClass, children: "Connections" }), _jsx(NavLink, { to: "/chat", className: linkClass, children: "Chat" }), _jsx(NavLink, { to: "/advanced-chat", className: linkClass, children: "Advanced Chat" }), _jsx(NavLink, { to: "/dashboard", className: linkClass, children: "Dashboard" }), _jsx(NavLink, { to: "/lab", className: linkClass, children: "Lab" })] }), authRequired && user && (_jsxs("div", { className: "flex items-center gap-2 border-l pl-4", children: [_jsx("span", { className: "text-xs text-gray-500", children: user.email }), _jsx("button", { onClick: logout, className: "rounded px-2 py-1 text-xs text-gray-500 hover:bg-gray-100 hover:text-gray-700", children: "Sign out" })] }))] })] }));
}
function PocApp() {
