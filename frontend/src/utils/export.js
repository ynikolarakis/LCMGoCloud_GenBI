...
export async function exportChatToPDF(messages, filename = "chat-export.pdf") {
    const { jsPDF } = await import("jspdf");
  ...
  `;
    ...
    try {
        ...
        for (let page = 0; page < totalPages; page++) {
            ...
            ctx.drawImage(canvas, 0, page * sliceHeightPx, canvas.width, thisSliceH, 0, 0, canvas.width, thisSliceH);
